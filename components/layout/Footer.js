      ...
      <footer className="footer">
        <div className="footer-1">
          <div className="container">
            <div className="row">
              <div className="col-lg-3 width-10">
                <div className="width-logo-important mb-10">
                  <img
                    src="assets/imgs/GvineImgs/Logos/svg/gcd-high-resolution-logo-color-on-transparent-background.png"
                    alt="Grapevine City Directory Logo"
                  />
                </div>
                ...
                <div className="font-md mb-20 color-grey-400">
                  <strong className="font-md-bold">Hours:</strong> 8:00am -
                  5:00pm, Mon - Sat
                </div>
