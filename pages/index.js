          ...
          <div className="container text-center">
            <div className="row mt-150">
              <div className="col-xl-8 col-lg-10 m-auto">
                ...
                <Link href="/#">
                  <img src="assets/imgs/template/google-play.png" alt="iori" />
                </Link> */}
              </div>
            </div>
          </div>
        ...
        <div className="section home12-logos">
          <div className="container">
            <ul className="lists-logo">
              ...
              <li>
                <img src="assets/imgs/page/homepage12/cuebiq.png" alt="iori" />
              </li>
              <li>
                <img src="assets/imgs/page/homepage12/factual.png" alt="iori" />
              </li>
              <li>
                <img src="assets/imgs/page/homepage12/placeiq.png" alt="iori" />
              </li>
              <li>
                <img src="assets/imgs/page/homepage12/airmeet.png" alt="iori" />
              </li>
              <li>
                <img src="assets/imgs/page/homepage12/spen.png" alt="iori" />
              </li>
              <li>
                <img src="assets/imgs/page/homepage12/klippa.png" alt="iori" />
              </li>
              <li>
                <img
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-sm-6 mb-30">
                      ...
                      <p className="font-xs color-grey-500">
                        ...
                        Praesent vulputate justo dictum nisl faucibus, eu
                        feugiat ex pretium. Duis sed mauris at nisi egestas
                        suscipit eget eu enim.
                      </p>
                    </div>
